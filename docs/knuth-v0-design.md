...
| `tool.invocation_completed` | `tool_call_id, outcome: succeeded \| failed \| denied, observation \| artifact_ref, observation_preview, tool_status?` | observation 是模型将看到的文本（≤8KB 内联，否则 artifact ref） |
